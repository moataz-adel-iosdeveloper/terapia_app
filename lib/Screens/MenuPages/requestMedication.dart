...
class _RequestMedicationState extends State<RequestMedication> {
  ...
  Widget build(BuildContext context) {
    ...
    child:ListView(children: [Column(verticalDirection: VerticalDirection.down,children: [
      GestureDetector(onTap: () {
        AddMedicineDialog(context, '');
      },child: Row(textDirection: TextDirection.ltr,children: [
        Container(margin:
      EdgeInsets.only (left: 15,top: 15),child:
      Text('Choose Medication   ',style: TextStyle(color: Colors.black,fontSize: 22
      ),),) ,
        Container(margin:
        EdgeInsets.only(top: 15),child:
       ...
       ListView.builder(shrinkWrap: true,
        physics: ScrollPhysics(),
         ...
         return Container(key: UniqueKey(),margin: EdgeInsets.only(right: 18,left: 18,top: 9,bottom: 9),
          ...
          child: Column(children: [
            Row(textDirection: TextDirection.ltr, children: [
              Expanded(flex: 1,
                  child: Container(margin:EdgeInsets.only(top: 9),
                    padding: EdgeInsets.all(8),
                    alignment: Alignment.center,
                    child: Image(image: AssetImage('images/logo.png'),),)),
              Expanded(flex: 2, child: Column(mainAxisAlignment:
              MainAxisAlignment.center,crossAxisAlignment:CrossAxisAlignment.start,
                children: [
                Container(margin: EdgeInsets.all(6), child:
                Text(medicineLista[index].name,
                  style: TextStyle(color: Colors.black, fontSize: 18),)),
                Container(margin: EdgeInsets.all(2), child:
                Text(medicineLista[index].type,
                  style: TextStyle(color: Colors.black, fontSize: 18),)),
                Container(margin: EdgeInsets.all(3), child:
                Text(medicineLista[index].quantity.toString(),
                  style: TextStyle(color: Colors.black, fontSize: 18),)),
              ],))
            ],),
                ...
                crossAxisAlignment: CrossAxisAlignment.center, children: [
                  ...
                  GestureDetector(onTap: () {
                    setState(() {
                      ...
                      margin:EdgeInsets.only(top: 9,right: 9,left: 9,bottom: 12),
                      width: 120,
                      decoration: new BoxDecoration(
                          color: Colors.red,
                          borderRadius:
                 ...
                 Flexible(flex:1,fit: FlexFit.loose,child:
                 GestureDetector(onTap: () {
                   EditMedicineDialog(context, medicineLista[index],index);
      ...
      GestureDetector(onTap: () {
        _openFileExplorer();
          ...
          height: 180,margin:EdgeInsets.only(right: 18,left: 18,top: 9,bottom: 25),
            alignment: Alignment.center,
            decoration: new BoxDecoration(
                color: Colors.white,
                borderRadius:
            ...
            child:Column(mainAxisAlignment:MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.center,children: [
              Visibility(visible: imagePath ==null,child: Row(mainAxisAlignment: MainAxisAlignment.center,children:
            [
              Text('Attach a prescription',style: TextStyle(color: Colors.black
                  ,fontSize: 17),textAlign: TextAlign.center,)
              ,              Icon(Icons.upload_sharp)
              ],)),
            Visibility(visible: imagePath != null,
                child:Image(image:imagePath!= null?FileImage(File(imagePath),):
            AssetImage('images/big_camera.png'),width: 240,height: 120
       ...
       Container(padding: EdgeInsets.all(11),
          width: 160,
          margin:EdgeInsets.only(top: 19,right: 39,left: 39,bottom: 22),
          alignment: Alignment.center,
          decoration: new BoxDecoration(
  ...
  return showDialog(
      builder:  (context){
        ...
        return SimpleDialog(
          ...
          children: [
            Row(children: [
        Flexible(flex:2,fit:FlexFit.loose,child: Container(margin: EdgeInsets.only(left: 14,top: 10),
                child: Text('Medicine Type ',style: TextStyle(color: Colors.black,fontSize: 12),),),
        ),
          ...
          },child:Container(margin: EdgeInsets.only(right: 10,left: 10,top: 10)
          ...
          child:
               Text(count.toString(),style: TextStyle(fontSize: 16,color: Colors.black),))
          ...
          count = count +1;
            ...
            new GestureDetector( onTap: () {
              if(count >0) {
                updateView();
                setState((){
                  medicineLista = List.from(medicineLista)..add(
                    new Medicine(_nameSelectedItem.id, _nameSelectedItem.name
                        , _typeSelectedItem.name, count));});
