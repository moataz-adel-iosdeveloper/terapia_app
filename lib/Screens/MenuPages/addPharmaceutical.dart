...
class _AddPharmaceuticalState extends State<AddPharmaceutical> {
  ...
  TextEditingController effectiveMaterialNameController = TextEditingController();
  FocusNode marketNameNode = FocusNode();
  FocusNode effectiveMaterialNameNode = FocusNode();
...
//                      cursorColor: white,
                            ...
                            onSubmitted: (v) {
                              FocusScope.of(context)
                                  .requestFocus(effectiveMaterialNameNode);
                            },
                            textAlign: TextAlign.start,
                            ...
                            decoration: const InputDecoration(
                              border: OutlineInputBorder(
                                borderSide: BorderSide(
                                    width: 0.4, style: BorderStyle.solid),
                              ...
                              // filled: true,
                              contentPadding:
                                  EdgeInsets.only(left: 9, right: 9, top: 7),
                            ),
                          ),
                        ),
                        Container(
                          ...
                          margin: EdgeInsets.only(left: 21, top: 15),
                          child: Text(
                            'Effective Material of the medicine',
                            textAlign: TextAlign.start,
                            style: TextStyle(color: Colors.black, fontSize: 18),
                          ),
                        ),
...
//                      cursorColor: white,
                        ...
                        Container(
                            ...
                            margin:
                                EdgeInsets.only(left: 23, right: 27, top: 10),
                        ...
                        Container(
                            ...
                            width: 160,
                            margin: EdgeInsets.only(
                                top: 19, right: 9, left: 9, bottom: 12),
                            alignment: Alignment.center,
                            decoration: new BoxDecoration(
  ...
  @override
  void initState() {
    TypeList.add(new Clients(1, 'Tap'));
    TypeList.add(new Clients(2, 'Box'));
    TypeList.add(new Clients(2, 'Injection'));
